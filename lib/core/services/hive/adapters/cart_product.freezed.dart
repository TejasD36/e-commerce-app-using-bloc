...
@HiveField(0) Products get product;@HiveField(1) int get quantity;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartProduct&&(identical(other.product, product) || other.product == product)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
...
@useResult
$Res call({
@HiveField(0) Products product,@HiveField(1) int quantity
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  Products product, @HiveField(1)  int quantity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartProduct() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  Products product, @HiveField(1)  int quantity)  $default,) {final _that = this;
switch (_that) {
case _CartProduct():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)  Products product, @HiveField(1)  int quantity)?  $default,) {final _that = this;
switch (_that) {
case _CartProduct() when $default != null:
return $default(_that.product,_that.quantity);case _:
  return null;
...
class _CartProduct implements CartProduct {
  const _CartProduct({@HiveField(0) required this.product, @HiveField(1) required this.quantity});
  

@override@HiveField(0) final  Products product;
@override@HiveField(1) final  int quantity;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CartProduct&&(identical(other.product, product) || other.product == product)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
